...
class Controller():
    ...
    def __init__(self,
        ...
        if filter_type == "KF":
            ...
            # P_init = np.array([[0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001],
            #                    [0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001],
            #                    [0.0001, 0.0001, 0.0001, 0.0001, 0.0001, 0.0001],
            #                    [0.0001, 0.0001, 0.0001,      1, 0.0001, 0.0001],
            #                    [0.0001, 0.0001, 0.0001, 0.0001,      1, 0.0001],
            #                    [0.0001, 0.0001, 0.0001, 0.0001, 0.0001,      1]])
            P_init = np.diag([0.001, 0.001, 0.001, 1, 1, 1])
            # Measurement noise Covariance Matrix
            R = np.array([[30.45326648, -3.27817233, -5.51873313],
                          [-3.27817233, 33.64031622,  1.07687012],
                          [-5.51873313,  1.07687012, 13.53362295]])
            Q = np.diag([0.0001, 0.0001, 0.0001, 1, 1, 1])
